...
class Good {
    ...
    render() {
        ...
        <a class="image__card-hover" href="cart.html"><img src="image/add_to_cart.png" alt="add_to_cart"></a><h3 class="heiding__card">${this._title}</h3><p class="card__description">${this._description}</p><p class="card__price">${this._price}</p></div>`;
    }
}
